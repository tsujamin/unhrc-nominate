...
input_folder <- "/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241210-140636-palestin-abstainisno-missingisno-pakistan-is-polar/"

# Used to iterate through each year of UNHRC data
unhrc_year_first <- 2006
unhrc_year_last  <- 2024

n_min_votes = 1 # EDIT THIS
...
polarity <- c("PAK") # Change this to country code of polar extreme
unhrc_all_years = load_rollcall('all')


all_wnom <- wnominate(unhrc_all_years, dims=1, minvotes=n_min_votes, polarity=polarity)
png(filename="/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241210-140636-palestin-abstainisno-missingisno-pakistan-is-polar/wnominate.png")
