...
input_folder <- "/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241210-133715-abstainisno-missingisno/"
...
png(filename="/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241210-133715-abstainisno-missingisno/dwnominate.png")
plot(nominate)
dev.off()

all_wnom <- wnominate(unhrc_all_years, dims=1, minvotes=n_min_votes, polarity=polarity)
png(filename="/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241210-133715-abstainisno-missingisno/wnominate.png")
plot.coords(all_wnom)
dev.off()

chn_usa_wnom <- wnominate(unhrc_all_years, dims=2, minvotes=n_min_votes, polarity=c("CHN", "USA"))
png(filename="/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241210-133715-abstainisno-missingisno/wnominate-CHN-USA.png")
...
write.csv(d_ordered, "/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241210-133715-abstainisno-missingisno/dimension.csv")
write.csv(nominate$legislators[,c("session", "name", "coord1D")], "/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241210-133715-abstainisno-missingisno/dimension-over-time.csv")