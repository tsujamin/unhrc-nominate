...
input_folder <- "/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241210-140328-develop-right to develop-development to the enjoyment-abstainisno-missingisno/"
...
png(filename="/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241210-140328-develop-right to develop-development to the enjoyment-abstainisno-missingisno/dwnominate.png")
plot(nominate)
dev.off()

all_wnom <- wnominate(unhrc_all_years, dims=1, minvotes=n_min_votes, polarity=polarity)
png(filename="/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241210-140328-develop-right to develop-development to the enjoyment-abstainisno-missingisno/wnominate.png")
plot.coords(all_wnom)
dev.off()

chn_usa_wnom <- wnominate(unhrc_all_years, dims=2, minvotes=n_min_votes, polarity=c("CHN", "USA"))
png(filename="/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241210-140328-develop-right to develop-development to the enjoyment-abstainisno-missingisno/wnominate-CHN-USA.png")
