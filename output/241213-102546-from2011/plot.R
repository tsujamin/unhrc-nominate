...
input_folder <- "/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241213-102546-from2011/"
...
png(filename="/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241213-102546-from2011/dwnominate.png")
plot(nominate)
dev.off()

all_wnom <- wnominate(unhrc_all_years, dims=1, minvotes=n_min_votes, polarity=polarity)
png(filename="/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241213-102546-from2011/wnominate.png")
plot.coords(all_wnom)
dev.off()

chn_usa_wnom <- wnominate(unhrc_all_years, dims=2, minvotes=n_min_votes, polarity=c("CHN", "USA"))
png(filename="/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241213-102546-from2011/wnominate-CHN-USA.png")
...
write.csv(d_ordered, "/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241213-102546-from2011/dimension.csv")

write.csv(nominate$legislators[,c("session", "name", "coord1D")], "/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241213-102546-from2011/dimension-over-time.csv")