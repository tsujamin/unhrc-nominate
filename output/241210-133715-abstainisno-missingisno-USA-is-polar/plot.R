...
input_folder <- "/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241210-133715-abstainisno-missingisno-USA-is-polar/"
...
polarity <- c("USA") # Change this to country code of polar extreme
...
png(filename="/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241210-133715-abstainisno-missingisno-USA-is-polar/dwnominate.png")
plot(nominate)
dev.off()

all_wnom <- wnominate(unhrc_all_years, dims=1, minvotes=n_min_votes, polarity=polarity)
png(filename="/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241210-133715-abstainisno-missingisno-USA-is-polar/wnominate.png")
plot.coords(all_wnom)
dev.off()

chn_usa_wnom <- wnominate(unhrc_all_years, dims=2, minvotes=n_min_votes, polarity=c("CHN", "USA"))
png(filename="/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241210-133715-abstainisno-missingisno-USA-is-polar/wnominate-CHN-USA.png")
...
write.csv(d_ordered, "/Users/benjaminroberts/projects/nominate/unhrc-nominate/output/241210-133715-abstainisno-missingisno-USA-is-polar/dimension.csv")